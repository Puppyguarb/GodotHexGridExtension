/**
 * @file RegisterExtension.cpp
 * @brief Designed to register the extension with Godot.
 * 
 * This file is mostly unaltered. You can find a reference to the Godot MIT license at
...
namespace
{
    ...
    ///
    /// @see GodotHexGridExtensionInitialize
    void initializeExtension( godot::ModuleInitializationLevel p_level )
    {
        ...
        godot::ClassDB::register_class<HexGrid>();
        godot::ClassDB::register_class<HexTile>();
        godot::ClassDB::register_class<GodotHexGridExtension>();
    }
...
extern "C"
{
    ...
    GDExtensionBool GDE_EXPORT GodotHexGridExtensionInitialize(
